...
const svg = select(chartContainer).append('svg')
  .attr('width', width)
  .attr('height', height);
...
//TODO: read csv
const rawData = [
    ['"Burgenland"', '"294436"', '"296010"', '"297583"', '"301250"', '"301951"', '"301819"\r'],
    ['"Kaernten"', '"561293"', '"562089"', '"564513"', '"568984"', '"569744"', '"570194"\r'],
    ['"Niederoesterreich"', '"1684287"', '"1690879"', '"1698796"', '"1718373"', '"1723723"', '"1727759"\r'],
    ['"Oberoesterreich"', '"1490279"', '"1495608"', '"1505140"', '"1522825"', '"1530349"', '"1535677"\r'],
    ['"Salzburg"', '"558410"', '"560710"', '"562606"', '"568346"', '"571479"', '"572905"\r'],
    ['"Steiermark"', '"1246395"', '"1247077"', '"1252922"', '"1265198"', '"1269801"', '"1271940"\r'],
    ['"Tirol"', '"757634"', '"760105"', '"764102"', '"771304"', '"775970"', '"777773"\r'],
    ['"Vorarlberg"', '"397139"', '"399237"', '"401674"', '"406395"', '"409973"', '"411748"\r'],
    ['"Wien"','"1911191"','"1920949"','"1931593"','"1982097"','"2005760"','"2028399"\r']
];
...
let infectedArray = [
    ['"Day"', '"Burgenland"', '"Kaernten"', '"Niederösterreich"', '"Oberoesterreich"', '"Salzburg"', '"Steiermark"',  '"Tirol"',  '"Vorarlberg"', '"Wien"'],
    ...
    for (let i = 1; i < infectedArray[1].length; i++) {
        ...
        if (currentDay > delay) {
            ...
            if (infectedArray[1][i] === 0) {
                ...
                infectedArray[1][i] = infectedArray[1][i] * Math.pow(infectRate, currentDay - delay);  
            }
        }
    }
...
function calculateInfectionPercentage(infectedArray, populationData) {
  ...
  const infectionPercentages = calculateInfectionPercentage(dailyData, transformedData);
  ...
  json("oesterreich.json").then(data => {
      ...
      svg.selectAll(".land")
          ...
          .attr("fill", function(d) {
            ...
            const provinceData = currentDayData.find(p => p.province === provinceName);
